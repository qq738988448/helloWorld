...
//a标签添加tabIndex=-1，tab键就获取不到概元素了;
bc.append("<a href=\"javascript:void(0)\" tabIndex=\"-1\"class=\"textbox-icon "+bb[i].iconCls+"\" icon-index=\""+i+"\"></a>");
}
}
